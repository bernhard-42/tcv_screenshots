...
def create_hexapod():
    ...
    hexapod = Assembly(
        children=[
            ...
            reference(
                stand, label="front_stand", color="skyblue", location=Pos(0, -60, 0)
            ),
            reference(
                stand, label="back_stand", color="skyblue", location=Pos(0, -120, 0)
            ),
        ]
        + legs,
        label="hexapod",
    ...
    hexapod.assemble(
        "/hexapod/back_stand", "j_bottom", "/hexapod/bottom", "j_back_stand"
    )
    hexapod.assemble(
        "/hexapod/front_stand", "j_bottom", "/hexapod/bottom", "j_front_stand"
    )
